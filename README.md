...
> **R: Porque cada #include copia el contenido completo de los headers del sistema, lo que más expande la cantidad de lineas en comparacion al archivo programa.c**
...
> **R: Porque en la etapa de preprocesamiento los comentarios se eliminan completamente**
...
> **R: Indican la correspondencia entre el codigo preprocesado y los archivos fuente originales, registrando el origen de cada bloque. printf proviene del archivo programa.c**
...
> **R: Estas instrucciones preparan el comienzo de la funcion sumar, con una etiqueta que marca el inicio de la funcion (_sumar:), una etiqueta interna del ensamblador (LFB14:), y luego las siguientes lineas se relacionan con el uso de una pila**
...
> **R: Porque 'area_circulo' no esta definida en programa.o, lo que hace que tenga tipo U (undefined) y si esta definida en matematica.o por lo que lleva la letra T (definido en la seccion text)**
...
> **R: Porque son funciones de la biblioteca dinamica del sistema, que como se cargan en tiempo de ejecucion, el enlazador no los copia, solo deja registrado sus nombres. Se resuelven al momento de la ejecucion con el cargador dinamico**
---
...
> **R: Una macro función reemplaza un nombre seguido de argumentos por una expresión, la macro se expande en tiempo de preprocesamiento, y el compilador nunca la ve, mientras que una función real desaparece en la etapa de ensamblado. Las macro funciones no tienen verificación de tipos mientras que las funciones reales si.**
...
> **R: Un símbolo tipo T indica que la función esta definida en ese mismo archivo en la sección de text (código ejecutable), donde se encuentran las instrucciones de maquina de las funciones, mientras que un símbolo tipo D indica una definición en la sección data, de una variable global con un valor inicial.**
